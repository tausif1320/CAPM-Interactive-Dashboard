...
with col1:
    stocks_list=st.multiselect("Choose 4 stocks",('TSLA','AAPL','NFLX','MSFT','MGM','AMZN','NVDA','GOOGL'),['TSLA','AAPL','NFLX','MSFT'])
with col2:
    year=st.number_input("Number of Years",1,10)

#Downloading Data of SP500
try:
    ...
    stocks_df['Date']=pd.to_datetime(stocks_df['Date']).astype('datetime64[ns]')
